...
#                 for patienceReduce in patienceReduces:
#                     inicio = time.perf_counter()
#                     hist, model,validation_generator,train_generator,name,patience,batch_size = trainModel(l2, taxaDropout, factor, min_lr, patienceReduce)
