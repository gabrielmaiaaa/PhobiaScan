...
if __name__ == '__main__':
    ...
    hist, model,validation_generator,train_generator,name,patience,batch_size,patienceReduce, seed = trainModel(l2, taxaDropout, factor, min_lr)
    ...
    saveTxt(newDir, best, last, l2, taxaDropout, fim-inicio, seed)
    saveCsv(name,best,last,newDir,l2,taxaDropout,min_lr,factor,patience,patienceReduce,batch_size,fim-inicio, seed)
